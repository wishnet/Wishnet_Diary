...
|
|	FALSE      = 已关闭
|	TRUE       = 已启用, take all query parameters into account.
|	             Please be aware that this may result in numerous cache
|	             files generated for the same page over and over again.
|	array('q') = 已启用, but only take into account the specified list
|	             of query parameters.
|
*/
...
|
*/
$config['encryption_key'] = 'tSRm_nZTKDou9%+%djxG=mE8NEcdLQ2Z';
...
$config['sess_cookie_name'] = 'riji_session';
...
$config['csrf_exclude_uris'] = array('gate');
